    ...
    return(
        <div className="bg-gray-950 flex h-screen">
            <div className="m-auto text-left">
                ...
                <p className="text-cyan-100 font-thin text-xl pt-10">I am a <span className="text-amber-200">Full Stack Software Engineer</span> with a passion for developing engaging and user-friendly single-page applications.</p>
